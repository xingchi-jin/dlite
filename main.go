...
func main() {
	...
	poller := poller.New("kmpySmUISimoRrJL6NL73w", "2f6b0988b6fb3370073c3d0505baee59", "dlite-xingchi", []string{"k8s-runner"}, managerClient, router)
	...
	eventsServer := bijou.New(managerClient, requestsChan)
